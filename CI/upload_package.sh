...
sftp -r -o StrictHostKeyChecking=no uploader@builds.vcmi.eu <<< "put $VCMI_PACKAGE_FILE_NAME.$PACKAGE_EXTENSION /uploads/$VCMI_PACKAGE_FILE_NAME.$PACKAGE_EXTENSION"
