...
Allows affected hero to open a marketplace after failing to pay surrender cost, sell resources, and retry surrender payment. This can be granted by artifacts, global/per-hero game config bonuses, or other bonus sources; player-wide bonuses are inherited by heroes.
