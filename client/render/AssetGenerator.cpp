...
void AssetGenerator::initialize()
{
	...
	imageFiles[ImagePath::builtin("MuPopUpCustom.bmp")] = [this](){ return createMuPopUpCustom();};
...
{
	auto locator = ImageLocator(ImagePath::builtin("MUPOPUP.bmp"), EImageBlitMode::OPAQUE);
	std::shared_ptr<IImage> img = ENGINE->renderHandler().loadImage(locator);
