...
private:
	...
	CanvasPtr createDialogWithStatusBarBackground(const Point & size, const PlayerColor & playerColor) const;
	CanvasPtr createRecruitmentBackground(const Point & size, const PlayerColor & playerColor) const;
