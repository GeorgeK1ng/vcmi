	...
	: screenType(ScreenType)
{
	...
	background = std::make_shared<CPicture>(ImagePath::builtin("MuPopUpCustom.bmp"));
	...
	statusBar = CGStatusBar::create(std::make_shared<CPicture>(background->getSurface(), Rect(7, 420, 440, 18), 7, 420));
